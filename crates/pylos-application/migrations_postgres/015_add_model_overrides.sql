...
ALTER TABLE model_catalog ADD COLUMN model_access_groups JSONB DEFAULT '[]'::jsonb;
ALTER TABLE model_catalog ADD COLUMN guardrails JSONB DEFAULT '[]'::jsonb;
ALTER TABLE model_catalog ADD COLUMN tags JSONB DEFAULT '[]'::jsonb;
ALTER TABLE model_catalog ADD COLUMN provider_params JSONB DEFAULT '{}'::jsonb;
