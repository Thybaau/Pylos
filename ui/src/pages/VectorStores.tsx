  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950 p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-semibold text-white">Vector Stores</h1>
      </div>
      <div className="flex-1 bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-8 flex flex-col items-center justify-center text-zinc-400">
        ...
        <h2 className="text-lg font-medium text-zinc-300 mb-2">Vector Stores Management</h2>
        <p className="text-sm max-w-md text-center">
          Manage vector databases and document embeddings.
        </p>
      </div>
    </div>
  )
